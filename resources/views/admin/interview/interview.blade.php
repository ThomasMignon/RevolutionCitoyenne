                ...
                <tbody>
                	@foreach ($interviews as $interview)
    					<tr>
    						...
    						<td>{{ $interview->create_at }}</td>
    						<td>
                            <?php
                            if($interview->visible != 0)
                                echo "Oui  ";
                            else
                                echo "Non  ";
                            ?>
    						...
    						<td><a href="{{env('APP_URL')}}index.php/admin/article/{{ $interview->id }}/edit" class="small-box-footer">Edit <i class="fa fa-pencil-square-o"></i></a>
                            <a href="{{env('APP_URL')}}test" class="small-box-footer">Delete <i class="fa fa-pencil-square-o"></i></a></td>
    					</tr>
					@endforeach        
                </tbody>
            </table>
